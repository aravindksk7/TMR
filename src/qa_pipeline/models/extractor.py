...
class ExtractorConfig(BaseModel):
    ...
    jira_api_version: str = "3"               # "2" for Server/DC, "3" for Cloud
    xray_variant: Literal["server", "cloud"] = "cloud"
    ...
    no_proxy: str | None = None                # comma-separated hosts that bypass the proxy
